...
<html>
  <head>
	...
	<script type="text/javascript" src="Javascript/jquery1.2.0.js"></script>
  	...
  	<script type="text/javascript" src="Javascript/SelectNewsResult.js"></script>
  	<style type="text/css">
    body{
      margin:0 auto;
    }
  ...
  $(document).ready(function(){
  	toRed("<s:property value='selectNewBytitle'/>");
	$("#selectNewform").val("");
  ...
  <%
      ...
      <div class="container-fluid">
        ...
        <s:form theme="simple" class="navbar-form navbar-left" action="selectNewsBytitleAction.action">
        	<div class="form-group">
          		<s:textfield name="selectNewBytitle" id="selectNewform"  class="form-control" placeholder="请输入新闻标题"/>
          		<s:submit class="btn btn-default" value="查询"/>
        	</div>
        	<a href="index.jsp" style="color:ivory;font-size: larger;margin-left:30px;margin-top:3px">返回首页</a>
        </s:form>
   ...
   <div style="width:1024px;margin-top: 20px;" class="center-block">
    <h1>查询"<s:property value="selectNewBytitle"/>"结果如下:</h1><hr/>
    
    <s:iterator value="newslistbyselect" var="news">
